...
static struct dynitem g_dynTileList[] =
{
    ...
    { "AP_NO_JUMP", DVPTR(AP_NO_JUMP), AP_NO_JUMP__STATIC, 0 },
    { "AP_NO_CROUCH", DVPTR(AP_NO_CROUCH), AP_NO_CROUCH__STATIC, 0 },
    { "AP_NO_SPRINT", DVPTR(AP_NO_SPRINT), AP_NO_SPRINT__STATIC, 0 },
    { "AP_NO_DIVE", DVPTR(AP_NO_DIVE), AP_NO_DIVE__STATIC, 0 },
    { NULL, NULL, -1, -1 },
};
...
int32_t AP_NO_JUMP = AP_NO_JUMP__STATIC;
int32_t AP_NO_CROUCH = AP_NO_CROUCH__STATIC;
int32_t AP_NO_SPRINT = AP_NO_SPRINT__STATIC;
int32_t AP_NO_DIVE = AP_NO_DIVE__STATIC;
int32_t AP_NO_OPEN = AP_NO_OPEN__STATIC;
int32_t AP_NO_USE = AP_NO_USE__STATIC;
